             ...
             <div class="col.md.3">
              ...
              <div class="col-md-9">
                 ...
                 <div class="mb-3">
                       ...
                       <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{old('email', $admin->email)}}" disabled>
                       @error('email')
                        <small class="invalid-feedback">{{$message}}</small> 
                       @enderror
                 </div>
                 ...
                 <div class="mb-3">
                       ...
                       <input type="password" name="current_password" class="form-control @error('current_password') is-invalid @enderror" id="current">
                 ...
                 <div class="mb-3">
                       ...
                       <input type="password" name="password" class="form-control new @error('password') is-invalid @enderror" disabled>
                       @error('password')
                        <small class="invalid-feedback">{{$message}}</small> 
                       @enderror
                 </div>
                 ...
                 <div class="mb-3">
                       ...
                       <input type="password" name="password_confirmation" class="form-control confirmed @error('password_confirmation') is-invalid @enderror" disabled>
