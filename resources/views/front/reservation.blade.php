            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="contact-form">
                        <form id="contact" action="{{route('front.store')}}" method="post">
                            @csrf
                          <div class="row">
                            <div class="col-lg-12">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <input type="number" min="1" max="12" name="number_guests" id="number-guests">
                            </div>
                            <div class="col-lg-6">
                                <div id="filterDate2">    
                            ...
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
                                <select value="time" name="time_id" id="time">
