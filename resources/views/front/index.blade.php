                    ...
                    <div class="col-lg-4">
                        <div class="chef-item">
                            <div class="thumb">
                                ...
                                <img src="{{$chef->Img_Path}}" alt="Chef #1">
                            </div>
                            <div class="down-content">
                                <h4> {{$chef->trans_name}} </h4>
                                <span>{{$chef->trans_special}}</span>
                            </div>
                        </div>
                    </div>
                    @endforeach
                            ...
                            <div class="row">
                                <div class="col-lg-6 offset-lg-3">
                                    <ul>
                                      ...
                                      <a class="d-inline" style="color:black;" href="{{route('front.single_time', $time->id)}}">
                                      <li>
                                            <img src="{{$time->Img_Path}}" alt=""> 
                                            {{$time->trans_name}}
                                      </li>
                                       </a>
                                      @endforeach
